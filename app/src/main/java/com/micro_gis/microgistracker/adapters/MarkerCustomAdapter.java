...
public class MarkerCustomAdapter extends ArrayAdapter<Marker> {
    ...
    private ArrayList<Marker> data = new ArrayList<Marker>();
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        holder.editplace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, EditMarkerActivity.class);
                EditMarkerActivity.marker = data.get(position);
